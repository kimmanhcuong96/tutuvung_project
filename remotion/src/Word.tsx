...
const meaningColorSets = [
    {
        word: "#f3effa",
        meaning: "rgba(230,220,245,0.9)",
        glow: "rgba(175,150,220,0.58)",
        shadow: "rgba(130,110,180,0.45)"
    },
    {
        word: "#e6f5ff",
        meaning: "rgba(210,235,250,0.9)",
        glow: "rgba(135,200,230,0.58)",
        shadow: "rgba(95,150,190,0.45)"
    },
    {
        word: "#e7f8f4",
        meaning: "rgba(210,240,232,0.9)",
        glow: "rgba(135,210,190,0.56)",
        shadow: "rgba(95,160,145,0.45)"
    },
    {
        word: "#f5f2e1",
        meaning: "rgba(235,225,195,0.9)",
        glow: "rgba(210,190,135,0.56)",
        shadow: "rgba(165,140,95,0.45)"
    },
    {
        word: "#f3f0ea",
        meaning: "rgba(230,220,210,0.9)",
        glow: "rgba(200,175,150,0.56)",
        shadow: "rgba(155,130,105,0.45)"
    },
    {
        word: "#eff4e8",
        meaning: "rgba(225,235,215,0.9)",
        glow: "rgba(180,200,150,0.56)",
        shadow: "rgba(135,150,110,0.45)"
    },
    {
        word: "#e9f1fb",
        meaning: "rgba(210,225,245,0.9)",
        glow: "rgba(150,175,215,0.56)",
        shadow: "rgba(110,135,170,0.45)"
    },
    {
        word: "#eef5ed",
        meaning: "rgba(220,235,220,0.9)",
        glow: "rgba(170,195,170,0.56)",
        shadow: "rgba(125,150,125,0.45)"
    },
    {
        word: "#eef2f5",
        meaning: "rgba(220,230,235,0.9)",
        glow: "rgba(165,185,195,0.56)",
        shadow: "rgba(120,140,150,0.45)"
    },
    {
        word: "#f2f0f6",
        meaning: "rgba(228,220,235,0.9)",
        glow: "rgba(180,165,200,0.56)",
        shadow: "rgba(135,120,155,0.45)"
    },
];
...
const IntroField: React.FC<{ word: string; frame: number }> = ({word, frame}) => {
    ...
    const isChineseWord = (w: string): boolean => {
        if (!w) return false;
        return /^[\u4E00-\u9FFF]+$/.test(w);
    };
